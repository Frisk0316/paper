...
ElasticNet is much less stable in this version of the v6 results.
Its Sharpe ratio is negative in several non-Trump configurations and turns
positive only when the Trump feature group is included, suggesting that the
penalty path is selecting a narrow and fragile subset of predictors rather
than a broadly reliable linear signal.
