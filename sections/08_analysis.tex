...
rank normalization fixes what the model is asked to learn, and gradient
accumulation makes that objective learnable in practice.
The corrected TFT Variable Selection Network is not part of this table,
because it is architecture-specific rather than a shared pipeline change.
...
\begin{table}[t]
\centering
\caption{Per-seed Sharpe ratio statistics (32 seeds, test set, PW).
...
\midrule
LSTM & Price+Tech    & +0.70 & 0.80 & $-$0.78 & +2.51 & +2.46 & 3.5$\times$ \\
LSTM & +Onchain      & +0.41 & 0.75 & $-$1.27 & +1.91 & +0.93 & 2.3$\times$ \\
LSTM & +Trump+ETF    & +0.26 & 0.70 & $-$1.49 & +1.84 & +2.13 & 8.2$\times$ \\
\midrule
TFT  & Price+Tech    & +0.24 & 0.84 & $-$1.11 & +2.18 & +0.19 & 0.8$\times$ \\
TFT  & +Onchain      & +0.51 & 0.71 & $-$1.53 & +1.72 & +1.30 & 2.5$\times$ \\
TFT  & +Trump+ETF    & +0.57 & 0.82 & $-$1.12 & +2.35 & +1.89 & 3.3$\times$ \\
\bottomrule
\end{tabular}
\end{table}
