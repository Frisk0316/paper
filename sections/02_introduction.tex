...
\begin{enumerate}
  ...
  \item \textbf{Corrected TFT Variable Selection Network.}
        We replace the standard lightweight VSN ($\sim$5K parameters) with
        a per-variable shared GRN ($\sim$27K parameters), closer to the
        original \citet{lim2021temporal} specification, and show that
        this correction substantially stabilizes feature selection.
\end{enumerate}
