...
attention, a full-scale Temporal Fusion Transformer (TFT), and a novel
...
The results show that deep learning becomes competitive when the ranking
objective is aligned with the cross-sectional task, although different
architectures remain best suited to different signal types.
