...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Variable Selection Network (VSN).}
        The full-scale VSN processes each variable through a shared GRN
        ...
        This design follows \citet{lim2021temporal}'s nonlinear variable
        selection mechanism rather than a lightweight linear VSN
